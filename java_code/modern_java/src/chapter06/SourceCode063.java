...
public class SourceCode063 {
    public static void main(String[] args) {
        ...
        //result
        caloricDishesByType.forEach( (b, dishes)  -> {
            dishes.forEach( d -> {System.out.print(d.getCalories() + " ");});
        ...
        //result
        caloricDishesByType2.forEach( (b, dishes)  -> {
            dishes.forEach( d -> {System.out.print(d.getCalories() + " ");});
            System.out.println(":" + b);
        });
        ...
        //result
        dishesNameByType.forEach( (b, dishes)  -> {
            dishes.forEach( d -> {System.out.print(d + " ");});
            System.out.println(":" + b);
        });
